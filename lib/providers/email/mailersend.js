  ...
  return (0, _createClass2["default"])(EmailMailerSendProvider, [{
    ...
    value: function () {
      var _send = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(request) {
        var _ref, id, userId, from, replyTo, subject, html, text, headers, to, cc, bcc, attachments, messageId, generatedId, parsedFrom, parsedTo, data, response, responseHeaders, _messageId, responseBody, _responseBody$errors, firstError, message;
